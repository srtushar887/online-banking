...
@section('admin')
    ...
    @if ($user->transfer_type == 2)

        <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#gencode">Generate (COT TAX ATC MFC) Code</button>
    @endif
    <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#action">Action</button>
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
    ...
    <div class="modal fade" id="action" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{route('admin.fund.action')}}" method="post">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            <label>Amount</label>
                        ...
                        <div class="form-group">
                            <label>Action</label>
                            <select class="form-control" name="acition">
