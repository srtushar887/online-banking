    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Transaction Authorization Code</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-box">
                ...
                <form class="parsley-examples" action="{{route('first.code.check')}}" method="post" enctype="multipart/form-data" novalidate="">
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="userName">Enter Transaction Authorization Code<span class="text-danger">*</span></label>
                            <input type="text" name="firt_code"  parsley-trigger="change" required=""  class="form-control" id="userName">
                        </div>
