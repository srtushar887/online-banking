        ...
        <div class="col-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-12">
                        <div>
                            <form class="form-horizontal" action="{{route('user.password.save')}}" method="post" role="form">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">New Password
                                    </label>
                                    <div class="col-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-2 col-form-label">Confirm New Password
